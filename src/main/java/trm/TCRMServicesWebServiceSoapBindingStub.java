...
public class TCRMServicesWebServiceSoapBindingStub extends org.apache.axis.client.Stub implements trm.TCRMServicesInterface
{
	...
	private static void _initOperationDesc1()
	{
		...
		oper.setReturnType(new javax.xml.namespace.QName(
				...
				"tcrmResponse"));
		oper.setReturnClass(trm.TcrmResponse.class);
	...
	public trm.TcrmResponse queryTCRM(
			...
			throws java.rmi.RemoteException
	{
		...
		try
		{
			...
			else
			{
				...
				try
				{
					return (trm.TcrmResponse) _resp;
				}
				catch (java.lang.Exception _exception)
				{
					return (trm.TcrmResponse) org.apache.axis.utils.JavaUtils
							.convert(
									_resp,
									trm.TcrmResponse.class);
				}
			}
		}
